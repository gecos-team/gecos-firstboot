...
from firstboot_lib.PreferencesDialog import PreferencesDialog

class PreferencesFirstbootDialog(PreferencesDialog):
    __gtype_name__ = "PreferencesFirstbootDialog"

    def finish_initializing(self, builder): # pylint: disable=E1002
        """Set up the preferences dialog"""
        super(PreferencesFirstbootDialog, self).finish_initializing(builder)
