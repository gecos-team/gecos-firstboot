...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        new_object = builder.get_object("firstboot_window")
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for firstboot."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for firstboot."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the FirstbootWindow."""
        self.destroy()
